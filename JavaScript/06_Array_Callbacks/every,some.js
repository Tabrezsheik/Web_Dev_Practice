...
console.log(`All students of Class A have a grade above 80: ${allAbove80}`);// output: false
...
console.log(`All students of Class B have a grade above 80: ${someAbove80}`);// output: true
...
console.log(`Some students of Class C have a grade above 80: ${someAbove80InC}`); // output: true
